...
type SelesnyaSymbolProps = {
  size?: number;
  className?: string;
} & SVGAttributes<SVGSVGElement>;

function SelesnyaSymbol({
  size = 48,
  className,
  ...props
}: SelesnyaSymbolProps) {
  const [c1, c2] = GUILD_COLORS.selesnya;
  return (
    <span role="img" aria-label="Selesnya Conclave" className={className}>
      <svg viewBox="0 0 100 100" width={size} height={size} {...props}>
        <defs>
          <linearGradient id="selesnyaGrad" x1="0" y1="0" x2="1" y2="1">
