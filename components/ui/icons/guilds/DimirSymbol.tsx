...
type DimirSymbolProps = {
  size?: number;
  className?: string;
} & SVGAttributes<SVGSVGElement>;

function DimirSymbol({ size = 48, className, ...props }: DimirSymbolProps) {
  const [c1, c2] = GUILD_COLORS.dimir;
  return (
    <span role="img" aria-label="House Dimir" className={className}>
      <svg viewBox="0 0 100 100" width={size} height={size} {...props}>
        <defs>
          <linearGradient id="dimirGrad" x1="0" y1="0" x2="1" y2="1">
