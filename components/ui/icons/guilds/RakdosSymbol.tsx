...
type RakdosSymbolProps = {
  size?: number;
  className?: string;
} & SVGAttributes<SVGSVGElement>;

function RakdosSymbol({ size = 48, className, ...props }: RakdosSymbolProps) {
  const [c1, c2] = GUILD_COLORS.rakdos;
  return (
    <span role="img" aria-label="Cult of Rakdos" className={className}>
      <svg viewBox="0 0 100 100" width={size} height={size} {...props}>
        <defs>
          <linearGradient id="rakdosGrad" x1="0" y1="0" x2="1" y2="1">
