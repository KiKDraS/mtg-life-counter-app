...
type IzzetSymbolProps = {
  size?: number;
  className?: string;
} & SVGAttributes<SVGSVGElement>;

function IzzetSymbol({ size = 48, className, ...props }: IzzetSymbolProps) {
  const [c1, c2] = GUILD_COLORS.izzet;
  return (
    <span role="img" aria-label="Izzet League" className={className}>
      <svg viewBox="0 0 100 100" width={size} height={size} {...props}>
        <defs>
          <linearGradient id="izzetGrad" x1="0" y1="0" x2="1" y2="1">
